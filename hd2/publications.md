...
<div class="container">
    ...
    <nav class="survey-nav">
        ...
        <a href="{{ '/hd2/publications' | relative_url }}" class="survey-nav-link active">Publications</a>
    ...
    <section class="content-section">
        ...
        <p>Publications that use HD2 data or are closely related to the survey:</p>
